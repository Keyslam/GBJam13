...
export class SlotMachineService extends Service {
    ...
    private reel1backup: SlotSymbol[] = ['lemon', 'bar', 'doubleshot']
    private reel2backup: SlotSymbol[] = ['lemon', 'lightning', 'heal']
    private reel3backup: SlotSymbol[] = ['lemon', 'bar', 'speedup']
