...
const image = love.graphics.newImage("assets/sprites/player/coin-pickup-particle.png");
const animation = createAnimation(image, 8, 8, 4, 0, 0.1);

const coinImpactPrefab = (entity: Entity, source: Entity) => {
...
export default coinImpactPrefab;
