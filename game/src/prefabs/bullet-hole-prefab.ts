...
const image = love.graphics.newImage("assets/sprites/effects/effect-bullethole.png");
const animations = {
    default: createAnimation(image, 8, 8, 1, 0, 0.05, "once", false)
}

export const bulletHolePrefab = (entity: Entity, x: number, y: number) => {
    entity
